  ...
  theme: {
    extend: {
      colors: {
        ...
        panel: "#121B2E",       // card / section panel background
        "panel-light": "#182437", // slightly lighter panel (hover / nested surfaces)
        edge: "#243047",        // hairline borders

        // Text colors
        ink: "#E7ECF3",         // primary text (off-white, not pure white)
        muted: "#8893A8",       // secondary / supporting text

        // Brand accents
        accent: "#3DD6C4",      // primary accent (teal/cyan) -> links, buttons, highlights
        "accent-dim": "#1F6E66",// darker teal for borders/backgrounds on accent elements
